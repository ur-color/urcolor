...
- `@urcolor/core` — библиотека CSS Color 4 без зависимостей (разбор, конвертация, сериализация, гамут-маппинг, интерполяция) и WebGL-генераторы градиентов на canvas для цветовых областей и слайдеров.
- `@urcolor/primitives` — слой поведения, не зависящий от фреймворка: перетаскивание, раскладки клавиш, модели каналов, обвязка canvas и data-атрибуты, общие для всех биндингов.
