      ...
      "/guide/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Color Ring", link: "/guide/vue/color-ring" },
            { text: "Color Triangle", link: "/guide/vue/color-triangle" },
            { text: "Color Wheel", link: "/guide/vue/color-wheel" },
            { text: "Color Picker", link: "/guide/vue/color-picker" },
          ],
        },
      ],
      "/components/": [
