...
import { CHECKERBOARD_BACKGROUND, CHECKERBOARD_REF, DATA_DISABLED, paintTriangleSurface } from "@urcolor/shared";
...
export class ColorTriangleGradient {
  ...
  private paint(canvas: HTMLCanvasElement): void {
    paintTriangleSurface({
      ...
      zChannel: this.root.isThreeChannel() ? this.root.zChannelKey() : undefined,
      vertices: this.root.vertices(),
