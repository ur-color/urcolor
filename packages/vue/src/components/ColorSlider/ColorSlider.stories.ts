...
import { ColorSliderRoot, ColorSliderTrack, ColorSliderGradient, ColorSliderThumb } from "./index";

type Story = StoryObj<typeof ColorSliderRoot>;

function horizontalSlider(props: Record<string, unknown> = {}) {
  return h(
    ColorSliderRoot,
...
function verticalSlider(props: Record<string, unknown> = {}) {
  return h(
    ColorSliderRoot,
...
function sliderPair(props: Record<string, unknown> = {}) {
    ...
    setup() {
      ...
      return () =>
        h("div", { class: "grid grid-cols-2 gap-6" }, [
          h("div", [h("div", { class: "text-xs text-gray-500 mb-1" }, "Default"), sliderPair(bind())]),
          h("div", [h("div", { class: "text-xs text-gray-500 mb-1" }, "Inverted"), sliderPair(bind({ inverted: true }))]),
        ]);
    },
  }));
}
...
export const HSL_Alpha: Story = { name: "HSL / Alpha", render: renderSlider({ colorSpace: "hsl", channel: "alpha" }) };
...
export const HSV_Alpha: Story = { name: "HSV / Alpha", render: renderSlider({ colorSpace: "hsv", channel: "alpha" }) };
...
export const HWB_Alpha: Story = { name: "HWB / Alpha", render: renderSlider({ colorSpace: "hwb", channel: "alpha" }) };
...
export const OKLCh_Alpha: Story = { name: "OKLCh / Alpha", render: renderSlider({ colorSpace: "oklch", channel: "alpha" }) };
...
export const OKLab_Alpha: Story = { name: "OKLab / Alpha", render: renderSlider({ colorSpace: "oklab", channel: "alpha" }) };
...
export const LCh_Alpha: Story = { name: "LCh / Alpha", render: renderSlider({ colorSpace: "lch", channel: "alpha" }) };
...
export const Lab_Alpha: Story = { name: "Lab / Alpha", render: renderSlider({ colorSpace: "lab", channel: "alpha" }) };
...
export const RGB_Alpha: Story = { name: "RGB / Alpha", render: renderSlider({ colorSpace: "srgb", channel: "alpha" }) };
...
export const DisplayP3_Alpha: Story = { name: "Display P3 / Alpha", render: renderSlider({ colorSpace: "display-p3", channel: "alpha" }) };
...
export const A98RGB_Alpha: Story = { name: "A98 RGB / Alpha", render: renderSlider({ colorSpace: "a98-rgb", channel: "alpha" }) };
...
export const ProPhotoRGB_Alpha: Story = { name: "ProPhoto RGB / Alpha", render: renderSlider({ colorSpace: "prophoto-rgb", channel: "alpha" }) };
...
export const Rec2020_Alpha: Story = { name: "Rec. 2020 / Alpha", render: renderSlider({ colorSpace: "rec2020", channel: "alpha" }) };
