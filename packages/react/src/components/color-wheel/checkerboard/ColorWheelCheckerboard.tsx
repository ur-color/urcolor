...
export interface ColorWheelCheckerboardProps extends ComponentPropsWithoutRef<"div"> {}

export const ColorWheelCheckerboard = forwardRef<HTMLDivElement, ColorWheelCheckerboardProps>(
