export { ColorSliderRoot, type ColorSliderRootProps } from "./root/ColorSliderRoot";
export { ColorSliderControl, type ColorSliderControlProps } from "./control/ColorSliderControl";
export { ColorSliderTrack, type ColorSliderTrackProps } from "./track/ColorSliderTrack";
...
export * as ColorSlider from "./index.parts";
