/**
 * The CSS Color 4 named-color keywords, mapped to their `#rrggbb` hex. `gray`
 * and its `grey` spellings are both present. `transparent` is handled specially
 * (transparent black) since it carries alpha the hex table can't express.
 */
